...
public class configuracaoBancoDeDados {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName("org.postgresql.Driver"); // declara configuracao de acesso
        dataSource.setUrl("jdbc:postgresql://localhost:5432/loja");
        dataSource.setUsername("postgres");// usuario
        dataSource.setPassword("12345");// senha
        return dataSource;
    }
    ...
    public JpaVendorAdapter jpaVendorAdapter() {
        ...
        adapter.setShowSql(true);// mostrar no console o sql, e interessante
